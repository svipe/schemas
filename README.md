...
Currently not vailable claims are ~~marked~~.
...
| location| string | geographical coordinates <+59.48693000,+18.30116340> +/- 10408.74m (speed 0.00 mps / course 0.00) @ 2021-05-27, | certificate| string | in the request set this to the hex encoded public key, in the response you get a base64 encoded X509 certificate |
